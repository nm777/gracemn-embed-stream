...
Installing "GraceMN Embedded Stream" can be done either by searching for "GraceMN Embedded Stream" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
